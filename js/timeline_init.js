var timeline = new TL.Timeline('e-learning-timeline', 'content/timeline/e-learning-timeline.json', { slide_padding_lr: 80, language: "es", use_bc: true, scale_factor: 0.7, duration: 900, timenav_height_min: 120, timenav_height: 120 });
